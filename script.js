 ...
 * - Filter, Add Order, Save/Load JSON (tetap)
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  renderLOMTable(lomData);         // inisialisasi tampilan LOM (jika ada)
});
...
/* ===================== (Opsional) Pewarnaan status chips ===================== */
